...
interface PrestamoRepository {
    ...
    suspend fun refrescarDatos(): Result<Unit>

    fun obtenerEvidenciasPorSolicitudFlow(solicitudId: Int): Flow<List<Evidencia>>
    suspend fun adjuntarEvidencia(evidencia: Evidencia): Result<Unit>
    suspend fun eliminarEvidencia(id: Int): Result<Unit>
    suspend fun reintentarSubidaEvidencia(id: Int): Result<Unit>
}
